...
- Daily Standups
    - If you are doing worklogs, these should be about what you still need to do
    - This can be quick and done over slack but should be done everyday (even if yall aren't working, so everyone knows its a zero day)

## Worklogs

- See worklog folder, it does help with the standup process and for review process.
